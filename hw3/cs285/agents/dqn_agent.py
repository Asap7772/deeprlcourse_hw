...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        if perform_random_action:
            ...
            # buffer_obs = self.replay_buffer.obs[self.replay_buffer_idx + 1-self.replay_buffer.frame_history_len:self.replay_buffer_idx +1]
            # buffer_obs = buffer_obs.reshape(tuple(list(buffer_obs.shape)[1:-1]+[-1]))
        ...
        if done: self.last_obs = self.env.reset().copy()
